...
var _mappings = _interopRequireDefault(require("../illustrations/mappings"));
...
function (_Component) {
  ...
  _createClass(Undraw, [{
    ...
    value: function render() {
      ...
      var Illustration = _mappings.default[name];

      if (!Illustration) {
        return null;
      }

      return _react.default.createElement(Illustration, rest);
    }
  }], [{
    key: "setDefaultProps",
    ...
    value: function setDefaultProps(props) {
      ...
      Object.assign(_defaultProps.default, props);
    }
  }]);
...
exports.default = Undraw;

_defineProperty(Undraw, "defaultProps", {
  height: _defaultProps.default.height,
  primaryColor: _defaultProps.default.primaryColor
});
